# -*- coding: utf-8 -*-
"""
Created on Wed Apr 10 20:23:20 2019
...
while ans == 4:
    ...
    print "Epelexe::\n ‘logistic’ -Sigmoidis 0/1\n2.‘tanh’- uperfovliki efaptomenh -1/1"
    #activation=input("")
    
    #hidden_layer_sizes=input("Akairea timi gia to plhthos neyronwn sto kryfo strwma")
    #max_iter=input("Dwse ari8mo megistwn epoxwn")
    
    mlpclass=MLPClassifier(solver='lbfgs',activation='logistic',hidden_layer_sizes=(5, 2)
    ,momentum=0.9,max_iter =2500,learning_rate='constant', learning_rate_init=0.001)
