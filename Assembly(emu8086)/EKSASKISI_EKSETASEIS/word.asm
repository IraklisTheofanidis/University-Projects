...
V4:	 
   ...
   INT 21H 
	...
	MOV DL, CH	; Metaferoume to athroisma apo ton AL ston DL gia na ginei to perasma meso kataxoriti
	CALL DISPLAY_HEX; Kaloume tin Display_hex  
	
	MOV DL, CL	; Metaferoume to athroisma apo ton AL ston DL gia na ginei to perasma meso kataxoriti
	CALL DISPLAY_HEX;
